...
const typographyVariants = cva('text-foreground', {
    variants: {
        variant: {
            ...
            subheading: 'text-xl sm:text-2xl md:text-3xl leading-7 font-semibold inter',
            content: 'leading-relaxed [&:not(:first-child)]:mt-6 text-base sm:text-lg md:text-xl inter',
