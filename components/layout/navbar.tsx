...
export const Navbar = () => {
    ...
    return (
        <nav className="fixed top-4 left-1/2 -translate-x-1/2 w-[90%] max-w-[1400px] z-[2000]">
            <div className="backdrop-blur-md rounded-2xl border border-white/20 shadow-lg shadow-black/10 bg-teal-950">
                <div className="container mx-auto px-4 md:px-8 py-4">
                    <div className="flex justify-between items-center">
                        ...
                        <div className={`${isMenuOpen ? 'flex' : 'hidden'} md:hidden absolute top-full left-0 right-0 mt-2 flex-col space-y-4 bg-teal-950 backdrop-blur-md rounded-2xl border border-white/20 p-4`}>
