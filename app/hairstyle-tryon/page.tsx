...
const key_features = [
  {
    id: 1,
    icon: handstar_icon,
    title: <>Hairstyle <br /> Try-On</>,
    bulletPoints: [
      "Explore short, medium, and long hairstyles",
      "Test trending cuts (bob, layers, pixie, curls, etc.) before committing",
      "AI maps your face shape to suggest the best looks"
    ]
  },
  {
    id: 2,
    icon: magnet_icon,
    title: <>Hair Colour <br /> Try-On</>,
    bulletPoints: [
      "Try natural shades (black, brown, blonde) and bold colours (reds, blues, highlights)",
      "Preview single tones, highlights, balayage, and ombré looks instantly"
    ]
  },
  {
    id: 3,
  ...
  return (
    <div className="min-h-screen bg-white text-black flex items-center justify-center flex-col relative">
          ...
          <div className="hero flex flex-col lg:flex-row items-center justify-center min-h-[84vh] md:min-h-screen max-h-screen relative">
            ...
            <div className="hero-content flex-1 z-[100] w-full">
              <Typography className="hero-title text-white" variant={"h1"}>
                Try Before You Style. Try Before You Colour.
              </Typography>
              <Typography className="hero-subtitle text-white max-w-2xl">
                Our Smart Mirror with AI-powered Virtual Try-On lets you experiment with hairstyles and hair colours in real-time — no regrets, just confidence in your look.
              </Typography>
            </div>
      ...
      <div id="key-features" className="section-2 min-h-screen w-full bg-white pb-10 relative overflow-hidden flex items-center justify-center">
        ...
        <div className="key-features p-4 pt-20  z-[100] relative max-w-[1400px] w-full flex flex-col items-center justify-center">
          <Typography
            className="key-features-title text-start text-teal-950"
            variant={"h1"}
          >
            Key Features
          </Typography>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-10 mt-4  md:mt-20 md:grid max-w-[1300px] ">
            {key_features.map((item) => (
              <div key={item.id} className="md:p-10 p-5 w-full rounded-3xl bg-white relative border shadow-lg">
                ...
                <Typography
                  className="description poppins !mt-4 text-teal-900"
                  variant={"content"}
                >
                  {item.bulletPoints.map((point, i) => (
                    <li key={i}>
                      <Typography variant="content" className="text-black !mt-0 leading-tight text-start">
                        {point}
                      </Typography>
                    </li>
                  ))}
      ...
      <div className=" bg-black w-full flex items-center justify-center relative overflow-hidden marquee-container mt-10 " id="try-styles">
        ...
        <div className="max-w-[1400px] w-full z-[100]">
          ...
          <div className="mb-6 md:p-20 p-5">
            <Typography variant="h1" className="font-semibold text-white text-center mb-2">Try these styles with us</Typography>

            <div className="mt-10 mb-10">
              <ClientOnlyMarquee />
            </div>

            <Typography variant="subheading" className=" font-semibold text-white text-center">Discover trending hairstyles for every look</Typography>
          </div>
        </div>
      </div>
